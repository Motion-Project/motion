...
#if defined(HAVE_MYSQL) || defined(HAVE_MARIADB) || defined(HAVE_PGSQL) || defined(HAVE_SQLITE3)
...
#endif /* defined HAVE_MYSQL || defined HAVE_MARIADB || defined HAVE_PGSQL || defined(HAVE_SQLITE3) */
