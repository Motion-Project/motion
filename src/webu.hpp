...
#define _INCLUDE_WEBU_H_
    ...
    #define WEBUI_METHOD_GET 0          /* The method for the web interface */
    #define WEBUI_METHOD_POST 1         /* The method for the web interface */
    ...
    struct webui_ctx {
        ...
        int   resptype;             /* indicator for the type of response to provide.  Html, text, json */
