...
void netcam_image_read_complete(netcam_context_ptr netcam)
{
    ...
    if (netcam->last_image.tv_sec) {
        ...
        //To save processing time and log space, this is disabled for regular processing
        //MOTION_LOG(DBG, TYPE_NETCAM, NO_ERRNO, "%s: Calculated frame time %f", netcam->av_frame_time);
    }
